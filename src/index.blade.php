...
<body style="overflow: hidden">
    ...
    <div class="border row bg-light" style="height: 60px">
    ...
    <div class="p-5 row">
        <div class="col-md-3">
            ...
            <div class="container-fluid" style="max-height: 650px; overflow-y: scroll">
                ...
                @forelse($mails as $mail)
                    <div class="container bg-light p-2 flex-column border-bottom mail mail--js {{ $mail->is_read ?: 'unread' }}"
                        data-id="{{ $mail->id }}">
                        <div>
                            {{ $mail->subject }}
                        </div>
        ...
        <div class="col-md-9">
            ...
            <div class="pl-3 row flex-column">
            ...
            <iframe id="mail-iframe" class="border" width="100%" height="650px">
    ...
    <script>
        $(function() {
            $(".mail").click(function() {
                ...
                $.get('/mailrifle/' + $(this).data('id'), function(response) {
